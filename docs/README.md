...
![结果](attachment/c++/202209281016529.png)
#### 变量&注释

![变量&注释](attachment/c++/202301300930814.png)
...
![helloworld](attachment/c++/202302011342788.png)
...
![](attachment/c++/202209272111396.png)

**使用：** Microsoft Visual C++ x64 
![](attachment/c++/202209272111396.png)

**使用:** Ubuntu GCC 
![](attachment/c++/202209272130447.png)
...
![抽象](attachment/c++/202302021210816.png)
...
一种使用连续内存，存储线性数据的结构。
![数组](attachment/c++/1704596937427.png)
...
```
![](attachment/c++/20240107162608.png)

#### 链表（Linked List）

一种使用非连续内存，存储线性数据的结构。
![链表](attachment/c++/1704597021696.png)
在内存的的表现为：
![](attachment/c++/1704598399549.png)
数据结构：
```cpp
...
```
###### 单链表（Link List）
![](attachment/c++/20240107212922.png)
###### 双向链表（Du-Link-List）
![](attachment/c++/20240107212936.png)
###### 循环链表（Cir-Link-List）
![](attachment/c++/20240107212946.png)


#### 队列（Queue）

一种先进先出（FIFO，First in First out）的线性结构；
![](attachment/c++/1704598431031.png)
...
**非循环队列**
![](attachment/c++/20240107160309.png)
```cpp
SqQueue.rear++
```

**循环队列**
![](attachment/c++/20240107160325.png)
```cpp
SqQueue.rear = (SqQueue.rear + 1) % SqQueue.maxSize
```

##### 链队列
![](attachment/c++/20240107164920.png)


#### 栈（Stack）

一种后进先出（LIFO，Last in First out）的线性结构；
![](attachment/c++/1704598464074.png)
...
```
![](attachment/c++/20240107150152.png)
...
![](attachment/c++/1704599070286.png)
...
二叉树顺序存储图片
![](attachment/c++/20240109155340.png)

###### 链式存储

二叉树链式存储图片
![](attachment/c++/20240109155718.png)
...
![](attachment/c++/20240110093417.png)
...
![](attachment/c++/20240110093438.png)
...
![](attachment/c++/20240110093540.png)
...
![](attachment/c++/20240110093555.png)
...
![](attachment/c++/20240110102614.png)
...
![](attachment/c++/20240110102708.png)
...
![](attachment/c++/1704599146655.png)
...
![](attachment/c++/20240110104153.png)
...
![](attachment/c++/20240110104725.png)

**查找效率为：**

![](attachment/c++/20240110141006.png)
###### 最小失衡树
...
![](attachment/c++/96a7aa160f13424abb4acd1ada47edbf.webp)  ![](attachment/c++/ba1adc2895cf4b1aaef2e7088d9f6a69.webp)

**图解代码**

![](attachment/c++/20240110141200.png)
...
![](attachment/c++/20240110111710.png)

**RR型**（根的右孩子的右子树插入导致不平衡）：根的右孩子左旋

![](attachment/c++/20240110111750.png)

**LR型**（根的左孩子的右子树插入导致不平衡）：根的左孩子左旋，再右旋

![](attachment/c++/20240110140144.png)

![](attachment/c++/20240110140242.png)

**RL型**（根的右孩子的左子树插入导致不平衡）：右孩子的左子树右旋，再左旋

![](attachment/c++/20240110140345.png)

![](attachment/c++/20240110140555.png)
...
![](attachment/c++/20240110234942.png)
 ...
 **变色**
 ...
 2. 如果 X 的 parent 为红，同时 uncle是红
 	...
 	![](attachment/c++/20240111101944.png)

**左旋右旋**：如果 X 的 parent 为红，同时 uncle是黑色

- **LL** ：Parent节点右旋，变色
	
	![](attachment/c++/20240111102450.png)

- **LR** ：先X节点左旋，再右旋，变色
	 
	 ![](attachment/c++/20240111102641.png)
	
- **RR** ：Parent节点右旋，变色
	 
	 ![](attachment/c++/20240111102749.png)
	
- **RL** ：先X节点右旋，再左旋，变色
	 
	 ![](attachment/c++/20240111102811.png)
...
![](attachment/c++/20240111170151.png)
分析：删除D即可

###### D为黑色叶子，兄弟为红

![](attachment/c++/20240111173238.png)
当前状态，D下面两个位Nil，S为红，SL和SR必定不为空。

需要将P左转，做变色

![](attachment/c++/20240111173713.png)

###### D为黑色叶子，兄弟为黑色叶子

- **P为黑**

![](attachment/c++/20240111181534.png)
分析：S改为红色

- **P为红**

![](attachment/c++/20240111181526.png)
...
![](attachment/c++/20240110165052.png)
...
![](attachment/c++/1704602842623.png)
...
![哈希](attachment/c++/20240108110041.png)
...
![](attachment/c++/1704602787115.png)
...
![简单工厂](attachment/design_pattern/01简单工厂.assets/简单工厂-类图.webp)
...
![运行结果](attachment/design_pattern/23状态模式.assets/202209142046458.png)
...
![建造者模式](attachment/design_pattern/24建造者模式.assets/建造者模式.drawio.png)
...
**运行结果：**
![运行结果](attachment/design_pattern/24建造者模式.assets/202209222030463.png)
...
![PhoneNumber](attachment/ddd/20231223125045.png)
...
![最终代码比较](attachment/ddd/20231223125155.png)
...
##### 1、将实名验证部分抽离
![实名验证部分抽离](attachment/ddd/20231223125909.png)
...
![抽提原理](attachment/ddd/20231223125950.png)
...
![User状态检查](attachment/ddd/20231223130032.png)
...
![3层结构的问题](attachment/ddd/20231223130157.png)
...
![分层架构](attachment/ddd/20231223130252.png)
...
![cola分包](attachment/ddd/20231223130333.png)
...
![用户接口层和应用层](attachment/ddd/20231223130425.png)

2、**领域层**的填充

![领域层](attachment/ddd/20231223130521.png)

3、**基础设施层** 的填充

![基础设施层](attachment/ddd/20231223130604.png)

#### 2、解决DTO臃肿问题

当前的DTO运行方式为：

![传统的读写](attachment/ddd/20231223130710.png)
...
![CQRS读写](attachment/ddd/20231223130721.png)
Command端与Query端都通过Application Service 进入系统，共享同一个数据库，但Command端只写入状态，Query端只读取状态。

**代码分包方式：**
![CDQS](attachment/ddd/20231223130733.png)
