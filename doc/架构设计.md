...
![PhoneNumber](img/架构/20231223125045.png)
...
![最终代码比较](img/架构/20231223125155.png)
...
##### 1、将实名验证部分抽离
![实名验证部分抽离](img/架构/20231223125909.png)
...
![抽提原理](img/架构/20231223125950.png)
...
![User状态检查](img/架构/20231223130032.png)
...
![3层结构的问题](img/架构/20231223130157.png)
...
![分层架构](img/架构/20231223130252.png)
...
![cola分包](img/架构/20231223130333.png)
...
![用户接口层和应用层](img/架构/20231223130425.png)

2、**领域层**的填充

![领域层](img/架构/20231223130521.png)

3、**基础设施层** 的填充

![基础设施层](img/架构/20231223130604.png)

#### 2、解决DTO臃肿问题

当前的DTO运行方式为：

![传统的读写](img/架构/20231223130710.png)
